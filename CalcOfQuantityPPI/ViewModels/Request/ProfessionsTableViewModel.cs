...
namespace CalcOfQuantityPPI.ViewModels.Request
{
    public class ProfessionsTableViewModel
    {
        ...
        public IEnumerable<int> QuantityOfEmployees { get; set; }
        public IEnumerable<int> QuantityOfPPIForOneEmployee { get; set; }
        public IEnumerable<int> TotalQuantityOfPPI { get; set; }
    }
}